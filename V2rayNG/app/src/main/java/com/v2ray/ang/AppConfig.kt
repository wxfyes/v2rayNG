...
object AppConfig {
    ...
    const val ANDROID_PACKAGE_NAME_LIST_URL = "$GITHUB_RAW_URL/wxfyes/androidpackagenamelist/master/proxy.txt"
    const val APP_URL = "$GITHUB_URL/wxfyes/v2rayNG"
    const val APP_API_URL = "https://api.github.com/repos/wxfyes/v2rayNG/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/wxfyes/v2rayNG/master/CR.md"
    const val APP_PROMOTION_URL = "aHR0cHM6Ly93d3cudGlhbnF1ZS5jYw=="
    const val TG_CHANNEL_URL = "https://t.me/jpxljsq"
